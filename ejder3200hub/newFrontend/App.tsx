...
import { useProAjandaStore } from './hooks/useProAjandaStore.ts';
import { View, EventType, Event, RsvpStatus, Idea, Resource, Task, Project, User, PurchaseRequest, Invoice, Role } from './types.ts';
import { generateFormFields } from './utils/formUtils.ts';
import { EventDetails } from './components/EventDetails.tsx';
import { IdeaDetails } from './components/IdeaDetails.tsx';
import { TaskForm } from './components/TaskForm.tsx';
import { ItemDetailView } from './components/views/ItemDetailView.tsx';
import { Login } from './components/Login.tsx';
import { X } from 'lucide-react';
import { TeamManagementModal } from './components/TeamManagementModal.tsx';
import { PurchaseRequestForm } from './components/PurchaseRequestForm.tsx';
import { InvoiceForm } from './components/InvoiceForm.tsx';
import { NewIdeaView } from './components/views/NewIdeaView.tsx';
import { DashboardView } from './components/views/DashboardView.tsx';
import { NewResourceView } from './components/views/NewResourceView.tsx';
import { HelpCenterView } from './components/views/HelpCenterView.tsx';
import { BackendView } from './components/views/BackendView.tsx';
import { useModalStore, ModalMode } from './hooks/useModalStore.ts';
